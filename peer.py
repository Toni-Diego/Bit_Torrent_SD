        ...
        try:
            with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
                ...
                if piece_index == self.total_pieces - 1:
                    last_piece_size = self.torrent_data['file_size'] % self.torrent_data['piece_size']
                    if last_piece_size > 0: expected_size = last_piece_size
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\nCerrando peer por petición del usuario...")
        peer.stop_event.set()